# From: https://ianthehenry.com/posts/how-to-learn-nix/an-infinite-list-of-functions/
...
# NOTE: the derivation function also creates a .drv file which is necessary
